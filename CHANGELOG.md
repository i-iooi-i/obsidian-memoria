...
## v2.4.1（2026-08-17 · 数据报告交互与透明背景兼容）

### 新增

- 全年活跃度下方新增当前年度的笔记数、字数与活跃日统计
- 全年热力图、月度分布和 24 小时节律图支持点击查看对应笔记摘要
- 点击摘要可回到 Memoria 主页面并定位到对应日期
- 图表交互支持键盘操作、中英文界面和移动端布局

### 优化

- 兼容 Style Context 背景图模式，Memoria 页面、卡片与回顾筛选控件可跟随工作区全透明显示
- 下钻结果保持只读，每次仅展示最近 6 条摘要，不改变笔记文件和原有统计口径

---

## v2.4.1-beta.1（2026-08-16 · 数据报告交互测试版）

本测试版用于提前体验数据报告交互，仅通过 GitHub Prerelease 分发，暂不提交 Obsidian 商店。
